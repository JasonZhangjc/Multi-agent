function [W, Wtotal, Z, mytimes, sol] = main_template_region4(fm1,A,h,W0,Obs,CA_flag,M0,fm2,t_deliver,t_spec1,t_spec2)
...
v_send = [];
v_pick = [];
v_pick = [zeros(1,3),1,zeros(1,14),0,zeros(1,17)];
v_send = [zeros(1,3),0,zeros(1,14),1,zeros(1,17)];
v_s_1 = 0;
v_p_1 = 0;
v_s_2 = 0;
v_p_2 = 0;
...
% fB2 = 0;
% fB3 = 0;
% WB1 = [zeros(1,3),100,zeros(1,14),100,zeros(1,17)];
% WB2 = [zeros(1,3),-400,zeros(1,14),0,zeros(1,17)];
% WB3 = [zeros(1,3),0,zeros(1,14),-400,zeros(1,17)];
% for t = 1 : t_deliver - 1
