function [W, Wtotal, Z, mytimes, sol] = main_template_region3(fm1,A,h,W0,Obs,CA_flag,M0,fm2,t_deliver,t_spec1,t_spec2)
...
v_send = [];
v_pick = [];
v_send = [zeros(1,12),1,zeros(1,20),0,zeros(1,2)];
v_pick = [zeros(1,12),0,zeros(1,20),1,zeros(1,2)];
v_s_1 = 0;
v_p_1 = 0;
v_s_2 = 0;
v_p_2 = 0;
...
% fB2 = 0;
% fB3 = 0;
% WB1 = [zeros(1,12),100,zeros(1,20),100,zeros(1,2)];
% WB2 = [zeros(1,12),-400,zeros(1,20),0,zeros(1,2)];
% WB3 = [zeros(1,12),0,zeros(1,20),-400,zeros(1,2)];
% for t = 1 : t_deliver - 1
...
F = [fInit, fObs, fDyn, fLoop, fLTL1, phi1==1, fLTL2, phi2==1, v_s_1==0, v_p_1==0, v_s_2==1, v_p_2==1 v_a_1==0, v_a_2==0];
