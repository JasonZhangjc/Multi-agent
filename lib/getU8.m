function [fU,phiU] = getU8(formula, args, k)

global Mw Z zLoop ZLoop bigM epsilon W W1 W2 Z1 Z2;
...
if k < h
    ...
    % [[phi1 U phi2]]_i+1
    [fU2,phiU2] = getU8(formula, args, k+1);
    fU = [fU, fU2];
