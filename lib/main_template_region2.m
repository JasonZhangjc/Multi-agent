function [W, Wtotal, Z, mytimes, sol] = main_template_region2(fm1,A,h,W0,Obs,CA_flag,M0,fm2,t_deliver,t_spec1,t_spec2)
...
v_send = [];
v_pick = [];
v_send = [zeros(1,2),1,zeros(1,20),0,zeros(1,12)];
v_pick = [zeros(1,2),0,zeros(1,20),1,zeros(1,12)];
v_s_1 = 0;
v_p_1 = 0;
v_s_2 = 0;
v_p_2 = 0;
...
% fB2 = 0;
% fB3 = 0;
% WB1 = [zeros(1,2),100,zeros(1,20),100,zeros(1,12)];
% WB2 = [zeros(1,2),-400,zeros(1,20),0,zeros(1,12)];
% WB3 = [zeros(1,2),0,zeros(1,20),-400,zeros(1,12)];
% for t = 1 : t_deliver - 1
