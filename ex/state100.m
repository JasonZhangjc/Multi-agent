...
f7 = strcat('FG(Neg(TP([',num2str(Room3),'],[2])))');   % FG([1 labels, <= 1]) at steady state at most one robot is left in the lower part
...
f10 = strcat('FG(TP([',num2str(setdiff(1:100,Room3)),'],[3]))'); 
...
fm1 = strcat('And(',f1,',',f4,',',f7,',',f10,',',f6,',',f9,',',f11,')');
fm2 = strcat('And(',f3,',',f5,',',f8,',',f11,')');
